...
const siteMetadata = {
  ...
  siteRepo: 'https://github.com/CodeWithRiyan',
  siteLogo: `${process.env.BASE_PATH || ''}/static/images/logo.png`,
  socialBanner: `${process.env.BASE_PATH || ''}/static/images/twitter-card.png`,
  mastodon: 'https://mastodon.social/@mastodonuser',
  email: 'marketing@riyan.id',
  github: 'https://github.com/CodeWithRiyan',
  x: 'https://twitter.com/x',
  // twitter: 'https://twitter.com/Twitter',
  facebook: 'https://www.facebook.com/pt.riyan.solusi.teknologi',
  youtube: 'https://youtube.com',
  linkedin: 'https://www.linkedin.com/company/riyan-id',
  ...
  analytics: {
    ...
    // },
    googleAnalytics: {
      googleAnalyticsId: 'G-T7SHB8MYG4', // e.g. G-XXXXXXX
    },
  },
  newsletter: {
  ...
  comments: {
    ...
    provider: undefined, // supported providers: giscus, utterances, disqus
    giscusConfig: {
